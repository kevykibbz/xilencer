    ...
    <div class="get-support">
        <div class="icon-wrap">
            <ul class="support-list">
                ...
                <li><a href="https://xgenious.com/support-center/" target="_blank">Contact Support</a></li>
            </ul>
                        ...
                        <div class="content-wrap with-step">
                            ...
                            <?php if ($database_errors > 0):?>
                                <div class="alert alert-danger mt-2" style="text-transform: capitalize;">your installation <strong>database.sql</strong> file is missing, re-download files from codecanyon, or
                                    <a href="https://xgenious.com/support-center/">contact support</a> </div>
                            <?php endif;?>
                            <button type="button" class="previous action-button">Previous</button>
...
<script src="../assets/common/js/jquery-migrate-3.4.0.min.js"></script>
<script>
    (function($){
        "use strict";
        ...
        $(document).on('click','#install_now',function (e){
            ...
            if (validateAdminField()){
                ...
                $.ajax({
                    ...
                    success: function (data){
                        console.log(data, data.type, data.msg);
                        $('#message_show').html('');
                        el.removeClass('animate-flicker');
                        el.text('Install Now');
                        var data = $.parseJSON(data);
