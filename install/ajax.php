...
if (isset($_POST['action']) && $_POST['action'] === '_install_script') {
    $installation_path = htmlentities(htmlspecialchars(strip_tags(trim($_POST['installation_path']))));
    $db_name = htmlentities(htmlspecialchars(strip_tags(trim($_POST['db_name']))));
    $db_username = htmlentities(htmlspecialchars(strip_tags(trim($_POST['db_username']))));
    $db_host = htmlentities(htmlspecialchars(strip_tags(trim($_POST['db_host']))));
    $db_password = htmlentities(htmlspecialchars(strip_tags(trim($_POST['db_password']))));
    $admin_email = htmlentities(htmlspecialchars(strip_tags(trim($_POST['admin_email']))));
    $admin_password = htmlentities(htmlspecialchars(strip_tags(trim($_POST['admin_password']))));
    $admin_username = htmlentities(htmlspecialchars(strip_tags(trim($_POST['admin_username']))));
    $admin_name = htmlentities(htmlspecialchars(strip_tags(trim($_POST['admin_name']))));
    ...
    try {
        ...
        $env_update_status = systemInstall([
            ...
            'your_app_url' => $installation_path
        ]);
...
function setAdminDetails($db,$admin_details)
{
    ...
    ----------------------------------------------------*/
    $create_admin =  $db->prepare("INSERT INTO `admins` (name,email,username,is_email_verified,role,image,password,remember_token,created_at,updated_at) VALUES (:name,:email,:username,:verified,:role,:image,:password,:token,:created,:updated)");
